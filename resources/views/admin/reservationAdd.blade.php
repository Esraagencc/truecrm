...
<section class="content">
    <div class="container-fluid">
        <div class="card card-default color-palette-box">
            <div class="card-body">
                <div class="col-12">
                <form action="{{ route('reservationSave')}}" method="POST">
                    @csrf()
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                            <input id="reservation_date" name="reservation_date" type="date" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            @foreach($reservation_types as $reservation_type)
                                <option value="{{ $reservation_type->id }}">{{ $reservation_type->name }}</option>
                            @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                            <input id="surgery_location" name="surgery_location" placeholder="İşlem yerini seçin" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="price" class="col-4 col-form-label">Ücret</label> 
                            <div class="col-8">
                            <input id="price" name="price" placeholder="Tutar girin" type="text" class="form-control">
                            </div>
                        </div> 
                            <div class="form-group row">
